...
Чтение из пустого файла.Чтение из файла с информацией.
...
Входные данные - число. Входные данные - строка.
...
Для данной задачи создан класс декоратора  validate_input, который будет проверять корректность входных данных для функций. Декоратор будет использоваться для двух функций: одна будет умножать число на 5, а другая будет проводить деление числа на 5. 
